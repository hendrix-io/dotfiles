...
warn "The agent fleet is Claude Code, Codex, the Cursor CLI, firstmate, gnhf,"
warn "no-mistakes, herdr, the third-party skills, and the AGENTS.md links for"
warn "every AI harness. Each agent CLI is inert until you log into it."
